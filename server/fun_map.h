...
struct FunMap map[] = {
   ...
   //rk_aiq_user_api_ae_ipc
    ...
    {"rk_aiq_user_api_ae_setLinAeRouteAttr"  ,   &rk_aiq_user_api_ae_setLinAeRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getLinAeRouteAttr"  ,   &rk_aiq_user_api_ae_getLinAeRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_setHdrAeRouteAttr"  ,   &rk_aiq_user_api_ae_setHdrAeRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getHdrAeRouteAttr"  ,   &rk_aiq_user_api_ae_getHdrAeRouteAttr_ipc  },
