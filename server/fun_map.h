...
struct FunMap map[] = {
   ...
   //rk_aiq_user_api_ae_ipc
    ...
    {"rk_aiq_user_api_ae_setLinAeDayRouteAttr"  ,   &rk_aiq_user_api_ae_setLinAeDayRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getLinAeDayRouteAttr"  ,   &rk_aiq_user_api_ae_getLinAeDayRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_setLinAeNightRouteAttr"  ,   &rk_aiq_user_api_ae_setLinAeNightRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getLinAeNightRouteAttr"  ,   &rk_aiq_user_api_ae_getLinAeNightRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_setHdrAeDayRouteAttr"  ,   &rk_aiq_user_api_ae_setHdrAeDayRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getHdrAeDayRouteAttr"  ,   &rk_aiq_user_api_ae_getHdrAeDayRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_setHdrAeNightRouteAttr"  ,   &rk_aiq_user_api_ae_setHdrAeNightRouteAttr_ipc  },
    {"rk_aiq_user_api_ae_getHdrAeNightRouteAttr"  ,   &rk_aiq_user_api_ae_getHdrAeNightRouteAttr_ipc  },
